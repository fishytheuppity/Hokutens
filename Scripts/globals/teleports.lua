...
function toMisCoast2(player)
   player:setPos(-50, -23, 571, 191, 25);
end;

function toSky2(player)
   player:setPos(-3, -34, -470, 198, 289);
end;

function tobayldbase(player)
   player:setPos(-11, -11, -104, 178, 70);
end;

function tobayldNPC(player)
   player:setPos(-362, 0, -289, 71, 70);
end;   
-----------------------------------
-- Telepoint Crags
-----------------------------------
